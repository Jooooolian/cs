...
int main()
{
    ...
    try
    {
        ...
        Time t04(t03);
        t04.SetSecond(45);          TestOutput<string>(num_tests, num_success, (string)t04, "{hours: 5, mins: 10, secs: 45}"    , "test 04 - SetSecond()");
                                    TestOutput<int   >(num_tests, num_success, t04.GetSecond(), 45                              , "test 05 - GetSecond()");
        ...
        Time t08(t06);
        t08.SetHours(10);           TestOutput<string>(num_tests, num_success, (string)t08, "{hours: 10, mins: 50, secs: 45}"   , "test 08 - SetHours()");
                                    TestOutput<int   >(num_tests, num_success, t08.GetHours(), 10                               , "test 09 - GetHours()");
